const readTopTenUserFollow = (account) =>
 `<li>
...
const readTopTenUserUnfollow = (account) =>
    `<li>
    <div class="single-chef">
        <a href="/account/information/${account.username}"><img src=${account.avatarImageUrl} alt="team" /></a>
        <div class="chef-detail">
...
const callTopTenAccountApi = async () => {
    ...
    for (var item of data) {
        ...
        let element = isFollowed ? readTopTenUserUnfollow(item) : readTopTenUserFollow(item);
...
const callTopAccountApi = async () => {
    ...
    for (var item of data) {
        let isFollowed = checkFollow(item.id, dataCheck);
        let element = isFollowed ? readTopUserUnfollow(item) : readTopUserFollow(item);
